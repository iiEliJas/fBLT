...
void blt_sgd_step_cpu(blt_tensor *param, const blt_tensor *grad, float lr) {
    blt_check_elementwise_fp32(param, grad, "blt_sgd_step: param and grad must be FP32 and elementwise-compatible");
...
void blt_adamw_step_cpu(blt_tensor *param, const blt_tensor *grad, blt_tensor *exp_avg, blt_tensor *exp_avg_sq,
    ...
    blt_check_elementwise_fp32(param, grad, "blt_adamw_step: param and grad must be FP32 and elementwise-compatible");
