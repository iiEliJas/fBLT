...
__global__ void blt_patch_pool_forward_kernel(const float* h, const blt_patch_info* patches,
                                              float* out, size_t num_patches, size_t embed_dim,
                                              int pool_max) {
...
extern "C" void blt_patch_pool_forward_cuda(const blt_tensor* byte_hidden, const blt_patch_info* patches,
                                            size_t num_patches, blt_patch_pool_type pool_type,
                                            blt_tensor* out) {
...
__global__ void blt_patch_pool_backward_kernel(const float* g, const float* h,
                                               const blt_patch_info* patches, float* gh,
                                               size_t num_patches, size_t seq_len,
                                               size_t embed_dim, int pool_max) {
    if (!pool_max) {
