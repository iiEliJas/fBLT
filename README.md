...
![ngram comparison](graphs/ngram_comparison.png)

![BPB vs throughput](graphs/patch_bpb_vs_throughput.png)
...
![nfe map](graphs/enc_dec_map.png)

BLT-S trades *more* decoder passes for *way fewer* encoder+global
...
rejected improvement ideas: [BENCHMARKS.md](docs/BENCHMARKS.md).**
